...
<center>
            ...
            <div class = "container border" style="background-color:white">
                ...
                <div class = "row" style="justify-content: center">
                        ...
                        <div class = "col-xl-2 col-lg-1 col-md-1" style="background-color:white">
                            <br>
                            <center>
                               <img src="images/shipimg.png" alt=Picture height="450px" >     
                            </center><br>
	...
	<br>
<h4 class = "a ws"><b>Nome Cliente:</b> </h4>
...
<br>
<b class = "ws"><input type = "submit" value= "Pagamento alla Consegna" name = "cash"> &ensp;
<input type = "submit" value= "Pagamento Online" name = "online"> </b>
