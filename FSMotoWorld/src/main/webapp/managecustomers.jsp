...
<body>
	...
	<br>
	<h1>Gestire Clienti</h1>
	<br>
	</div>
	<br>
	
	<div class = "container">
		<h2>Tutti i dettagli dei clienti</h2>
		...
		<thead style='background-color:#ebe9eb'>
			<tr>
				...
				<th style='border: 1px solid ; text-align: center'>Telefono</th>
		...
		<%
			...
			<tr>
				...
				<td style='border: 1px solid ; text-align: center'> <a href = 'carta.jsp?custname=<%=c.getName()%>' >Carrello <%=c.getName() %></a></td>
