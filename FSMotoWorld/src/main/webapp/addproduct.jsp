...
<title>Aggiungere Prodotto</title>
...
<body>
	...
	<br>
	<h1>Aggiungere Nuovo Prodotto</h1>
	<br>
	</div>
	<br>
	 ...
	 <div class="container border">
		...
		<% 
			...
			<h4><b class="b"> Seleziona Categoria:</b></h4>
		...
		<%
			...
			<h4><b class="e">Nome Prodotto:</b></h4>
			<h2><input type=text name="pname" class = "c" required></h2>
			
			<h4><b class="d">Prezzo Prodotto:</b></h4>
			...
			<h4><b class="g">Immagine Prodotto:</b></h4>
			...
			<br><br>
			<h3><b><input type=submit value="Aggiungere prodotto" ></b></h3>
