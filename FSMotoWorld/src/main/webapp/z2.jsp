...
<%if(msgg != null)
	...
	{%>
		...
		<%if(Total != 0)
			{%>
		<a href='ShippingAddress.jsp?Total=<%= Total %> + &CusName=<%= CusName%> +' ><h5><b class = "pd">  Procedere al checkout</b></h5></a>
		<%}
		else if(Total == 0)
		{%>
			<a onclick = "show()"><h5><b class = "pd"><h5><b>  Procedere al checkout</b></h5></a>
		<%}%>
